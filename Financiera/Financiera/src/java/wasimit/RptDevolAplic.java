 ...
 */
public class RptDevolAplic extends AbstractPageBean {
    ...
    public String btliquidarRL_action() {
        try {
            ...
            PageReport =  Constants.darPathApp( this.getFacesContext() ) + "ReportEngine?NameFilter=CSV" +
                    "&P_FEC_INI=" + formatter.format(fi) +
                    "&P_FEC_FIN=" + formatter.format(ff)
                    ;
              
            PageReport = PageReport + "&rptfilename=" + "DevolucionesAplic";
