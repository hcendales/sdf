 ...
 */
public class ReporteValidacionLocal extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        ddTipoRecaudoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("Seleccione", "Seleccione"), new com.sun.rave.web.ui.model.Option("TODOS", "Todos"), new com.sun.rave.web.ui.model.Option("SIMIT", "Simit"), new com.sun.rave.web.ui.model.Option("POLCA", "Polca")});
    ...
    public String btReport_action() {
        ...
        try {
           ...
           con = Constants.getJdbcDataSource().getConnection();
            ...
            cs = con.prepareCall(Constants.validaRecaudoLocal);
            
            java.sql.Date fec = new java.sql.Date(this.cfecIni.getSelectedDate().getTime());
            cs.setDate("p_fec_ini", fec);
        
            fec = new java.sql.Date(this.cfecFin.getSelectedDate().getTime());
            cs.setDate("p_fec_fin", fec);
            ...
            PageReport =  Constants.darPathApp ( this.getFacesContext() ) + "ReportEngine?NameFilter=" + (String)ddFormato.getValue() +
                    ...
                    "&P_TIPO=" + this.ddTipoRecaudo.getValue().toString() +
                    "&P_CONCESIONARIO=" + concecionario +
                    "&P_BANCO=" + banco;
                                
            PageReport = PageReport + "&rptfilename=" + "VerificacionSimitLocal";
