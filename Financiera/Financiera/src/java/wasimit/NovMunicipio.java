 ...
 */
public class NovMunicipio extends AbstractPageBean {
    
    private CachedRowSetDataProvider municipioDataProvider = new CachedRowSetDataProvider();
    
    private String ddBancoAct;
    private String ddTipoAct;
    private String tfCuentaAct;
    private String tfNitCtaAct;
    ...
    public String btAdicionar_action() {
        ...
        try {
            ...
            if ( this.ddBancoAct1.getValue() != null)
                ddBancoAct = this.ddBancoAct1.getValue().toString();
            
            if(this.ddTipoAct1.getValue() != null)
                ddTipoAct = this.ddTipoAct1.getValue().toString();
            
            if(this.tfCuentaAct1.getText() != null)
                tfCuentaAct = this.tfCuentaAct1.getText().toString();
            
            if (this.tfNitCta1.getText() != null)
                tfNitCtaAct = this.tfNitCta1.getText().toString();
            
            if (!this.ddBanco.getValue().toString().equals(ddBancoAct) ||
                !this.ddTipo.getValue().toString().equals(ddTipoAct) ||
                !this.tfCuenta.getText().toString().equals(tfCuentaAct) ||
                !this.tfNitCta.getText().toString().equals(tfNitCtaAct) )
            ...
            if (this.btAdicionar.getText().toString().equals("Adicionar"))
                cs = con.prepareCall(Constants.NovMunicipioAdd);
            else
                cs = con.prepareCall(Constants.NovMunicipioUpd);
            ...
            String numNovedad = cs.getString(33);
            
            info("Se genero novedad : " + numNovedad);
            ...
            tfAcuerdoP.setValue("");
            tfDnsAvvillas.setValue("");
            tfDnsDavivienda.setValue("");
            ddBancoAct1.setValue("");
            ddTipoAct1.setValue("");
            tfCuentaAct1.setValue("");
            tfNitCta1.setValue("");
           
            ddMunicipio.setValue("00000000");
            
            btAdicionar.setText("Adicionar");
            this.btAdicionar.setDisabled(true);
    ...
    public String  btEditar_action() {
        try {
            ...
            this.ddBancoAct1.setValue(cs.getString(13));
            this.ddTipoAct1.setValue(cs.getString(14));
            this.tfCuentaAct1.setText(cs.getString(15));
            this.tfNitCta1.setText(cs.getString(16));
    ...
    public void reporteNovedad(String numNovedad) {
        ...
        if (numNovedad.startsWith("01")) //Adicion municipio
            rptName = "novMunicipio";
        
        if (numNovedad.startsWith("02")) //Modificacion municipio
            rptName = "novMunicipio";
