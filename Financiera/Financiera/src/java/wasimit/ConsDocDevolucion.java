 ...
 */
public class ConsDocDevolucion extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        vw_soportedevolucionDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.vw_soportedevolucionRowSet}"));
    }
    ...
    private CachedRowSetDataProvider vw_soportedevolucionDataProvider = new CachedRowSetDataProvider();

    public CachedRowSetDataProvider getVw_soportedevolucionDataProvider() {
        return vw_soportedevolucionDataProvider;
    }

    public void setVw_soportedevolucionDataProvider(CachedRowSetDataProvider crsdp) {
        this.vw_soportedevolucionDataProvider = crsdp;
    }
    ...
    private TextField tfNombre1 = new TextField();

    public TextField getTfNombre1() {
        return tfNombre1;
    }

    public void setTfNombre1(TextField tf) {
        this.tfNombre1 = tf;
    }
    ...
    public void destroy() {
        ...
        vw_soportedevolucionDataProvider.close();
    }
    ...
    private String  CargarNovedadDevolucion() {
        try {
            ...
            Double numIdeC = new Double(cs.getDouble("V_IDENTIFICACION"));
            String strC = new DecimalFormat("#").format(numIdeC);
            txtNumIdentificacion.setText(strC);
            ...
            Double numIdeCC = new Double(cs.getDouble("V_IDENTIFICACIONC"));
            String strCC = new DecimalFormat("#").format(numIdeCC);
            txtNumIdentificacion1.setText(strCC);
            ...
            getSessionBean1().getVw_soportedevolucionRowSet().setObject(1,  Novedad[1]);
            
            this.vw_soportedevolucionDataProvider.refresh();
    ...
    public String btAgregar_action() {
        ...
        // case name where null will return to the same page.
            ...
            if ( getSessionBean1().getnovedad() == null )
            ...
            if (tfNombre1.getText() == null)
                throw new Exception("Nombre documento requerido");
            
            if (tfNombre1.getText().toString().length() == 0)
                throw new Exception("Nombre documento requerido");
            ...
            con = Constants.getJdbcDataSource().getConnection();
            cs = con.prepareCall(Constants.cargueDocSop);
            
            // Cargamos los parametros de entrada IN
            cs.setString("p_idnovedad", Novedad[1]); // p_id_recaudo_local_ajustes
            cs.setString("p_filename", uploadedFileName);
            cs.setString("p_nombreDocumento", tfNombre1.getText().toString());
    ...
    public String beliminar_action() {
        ...
        // case name where null will return to the same page.
            ...
            con = Constants.getJdbcDataSource().getConnection();
            cs = con.prepareCall(Constants.soporteDevDel);
    ...
    public String bver_action() {
        ...
        // case name where null will return to the same page.
            ...
            String PageReport =  Constants.darPathApp( this.getFacesContext() ) + "VerDocDev?IdDoc=" + idDoc;
