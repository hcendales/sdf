 ...
 */
public class ReporteLiqDeposSinIden extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ddFormatoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("XLS", "Excel"), new com.sun.rave.web.ui.model.Option("CSV", "Plano")});
    ...
    public String btReport_action() {
        ...
        try {
            ...
            if(ddTipoRecaudo.getValue().toString().equals("Simit"))
                    PageReport = PageReport + "&rptfilename=" + "LiquidacionSimitLocalDepos";

            if(ddTipoRecaudo.getValue().toString().equals("Polca"))
                    PageReport = PageReport + "&rptfilename=" + "LiquidacionPolcaLocalDepos";
