...
public class IdentificacionDepos extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        ddEstadoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("SI", "Sin Autorizar")});
    ...
    public void init() {
        ...
        try {
            ...
            //this.vw_valortrfDataProvider.refresh();
    ...
    public String bsalvar_action() {
        ...
        try {
            ...
            if (this.trxsinidentificarDataProvider.getRowCount() > 0) {
                ...
                info("Registros procesados " + numReg + "Resultado:" + salida);
            };
