 ...
 */
public class LiquidarExterno extends AbstractPageBean {
    ...
    public String btLiquidar_action() {
        ...
        try {
            ...
            cs = con.prepareCall(Constants.LiqRecExt);
            ...
            info("Proceso Liquidación, Dispersion, Contabilidad Correcto. Registros procesados:" + resultado);
