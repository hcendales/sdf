 ...
 */
public class EnvioBancoLocal extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ddBancoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("99", "Seleccione"), new com.sun.rave.web.ui.model.Option("52", "Avvillas"), new com.sun.rave.web.ui.model.Option("51", "Davivienda")});
    }
    ...
    public String btLiquidar_action() {
        ...
        try {
            ...
            if (this.clFechaIni.getSelectedDate() == null)
                throw new Exception("Seleccione Fecha Transferencia");
          
            con = getJdbcDataSource().getConnection();
            cs = con.prepareCall(Constants.envioBancoLocal);
            ...
            logAvvillas.setText(cs.getString(7));
    ...
    try {
            ...
            if (ddBanco.getSelected().toString().equals("52"))
                cs = con.prepareCall(Constants.verLogEnvioAvvillasLoc);
            
            if (ddBanco.getSelected().toString().equals("51"))
                cs = con.prepareCall(Constants.verLogEnvioDaviviendaLoc);
