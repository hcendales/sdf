 ...
 */
public class TransferirExterno extends AbstractPageBean {
    ...
    public String btLiquidar_action() {
        ...
        try {
            ...
            cs = con.prepareCall(Constants.trfRecExt);
            ...
            info("Proceso Transferencia Correcto. Registros procesados:" + resultado);
