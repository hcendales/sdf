...
public class AjustesLocal extends AbstractPageBean {
    ...
    public void init() {
        ...
        if ( ddPeriodoDefaultOptions.getOptions().length == 0 ) {
            com.sun.rave.web.ui.model.Option[] opt = new com.sun.rave.web.ui.model.Option[24];
...
//                this.recaudo_local_ajustesDataProvider.refresh();
    ...
    public String btAgregar_action() {
        ...
        try {
            ...
            cs.setInt(++pos, vigencia_fin_dia );
            ...
            if (this.cbAcuerdo.getValue() == null )
                cs.setInt(++pos,0);
            else
                if (this.cbAcuerdo.getValue().toString().equals("true"))
                    cs.setInt(++pos,1);
                else
                    cs.setInt(++pos,0);
            ...
            getSessionBean1().getRecaudo_local_ajustesRowSet().setObject(
                    2,(String) this.ddQuincena.getSelected());
