 ...
 */
public class ReversarIdentificacion extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        trxsinidentificarDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.trxsinidentificarRowSet3}"));
        ...
        ddEstadoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("ID", "Autorizados")});
    ...
    public void init() {
        ...
        try {
            ...
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(1,"190001");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(2,"XXXXXX");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(3,"999999999");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(4,"999999999");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(5,"TODOS");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(6,"TODOS");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(7,"ID");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(8,"ID");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(9,"0");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(10,"0");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(11,"99");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(12,"99");
    ...
    public void ddPeriodo_processValueChange(ValueChangeEvent event) {
        ...
        try {
            ...
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(1,ddPeriodo.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(2,ddPeriodo.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(3,ddCuenta.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(4,ddCuenta.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(5,ddMunicipio.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(6,ddMunicipio.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(7,ddEstado.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(8,ddEstado.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(9,"0");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(10,"0");
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(11,ddCon.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet3().setObject(12,ddCon.getSelected());
    ...
    public String bsalvar_action() {
        ...
        try {
            ...
            if (this.trxsinidentificarDataProvider.getRowCount() > 0) {
                ...
                info("Registros procesados " + numReg + "Respuesta: " + salida);
            };
