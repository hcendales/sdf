 ...
 */
public class cargueArchivoDev extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        ddtipocargueDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("", "Seleccione"), new com.sun.rave.web.ui.model.Option("DEV", "Historico devoluciones")});
    }
    ...
    public String uploadFileButton_action() {
        ...
        try{
            ...
            if( !this.ddtipocargue.getValue().toString().equals("DEV") )
            ...
            cs = con.prepareCall(Constants.carguearchivoDev);
