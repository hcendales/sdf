 ...
 */
public class ReporteCausacionExterno extends AbstractPageBean {
    ...
    private Label tipo_Causación1 = new Label();
    
    public Label getTipo_Causación1() {
        return tipo_Causación1;
    }
    
    public void setTipo_Causación1(Label l) {
        this.tipo_Causación1 = l;
    }
     ...
     */
    public ReporteCausacionExterno() {
    }
        ...
        try {
            ...
            if(this.ddTipoCausación.getValue().toString().equals("Gasto")){
                if(ddTipoRecaudo.getValue().toString().equals("Simit"))
                    PageReport = PageReport + "&rptfilename=" + "CausacionGasSimitExterno";
                else if(ddTipoRecaudo.getValue().toString().equals("Polca"))
                    PageReport = PageReport + "&rptfilename=" +  "CausacionGasPolcaExterno";
            }
            
            if(this.ddTipoCausación.getValue().toString().equals("Ingreso")){
                if(ddTipoRecaudo.getValue().toString().equals("Simit"))
                    PageReport = PageReport + "&rptfilename=" + "CausacionIngSimitExterno";
                else if(ddTipoRecaudo.getValue().toString().equals("Polca"))
                    PageReport = PageReport + "&rptfilename=" +  "CausacionIngPolcaExterno";
            }
