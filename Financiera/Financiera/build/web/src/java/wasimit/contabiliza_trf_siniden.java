 ...
 */
public class contabiliza_trf_siniden extends AbstractPageBean {
     ...
     */
    public contabiliza_trf_siniden() {
    }
    ...
    protected RequestBean1 getRequestBean1() {
        ...
        try {
            ...
            cs = con.prepareCall(Constants.contaSinIde);
            ...
            cs.setInt("p_feccor_ini_ano", fecha_ini_ano );
            cs.setInt("p_feccor_ini_mes", fecha_ini_mes );
            cs.setInt("p_feccor_ini_dia", fecha_ini_dia );
            cs.setInt("p_feccor_fin_ano", fecha_fin_ano );
            cs.setInt("p_feccor_fin_mes", fecha_fin_mes );
            cs.setInt("p_feccor_fin_dia", fecha_fin_dia );
            ...
            Date fi = this.calendarFecIni.getSelectedDate();
            Date ff = this.calendarFecFin.getSelectedDate();
            
            PageReport =  Constants.darPathApp ( this.getFacesContext() ) + "ReportEngine?NameFilter=CSV1" +
                    "&P_FEC_INI=" + formatter.format(fi) +
                    "&P_FEC_FIN=" + formatter.format(ff);
              
            PageReport = PageReport + "&rptfilename=" + "ContabilidadRecaudoSin";
