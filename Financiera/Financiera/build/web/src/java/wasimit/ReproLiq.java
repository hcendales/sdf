 ...
 */
public class ReproLiq extends AbstractPageBean {
    ...
    public String btLiquidar_action() {
        ...
        try {
            ...
            if (this.clFechaIni.getSelectedDate() == null)
                throw new Exception("Seleccione Fecha Corte inicial");
          
            if (this.clFechaFin.getSelectedDate() == null)
                throw new Exception("Seleccione Fecha Corte Final");
     
            con = Constants.getJdbcDataSource().getConnection();
            cs = con.prepareCall(Constants.reproLiquidacion);
      
            cs.setString("V_IDBANCO",ddBanco.getSelected().toString());
            ...
            cs.setInt("V_FECHA_COR_INI_ANO", fecha_ini_ano );
            cs.setInt("V_FECHA_COR_INI_MES", fecha_ini_mes );
            cs.setInt("V_FECHA_COR_INI_DIA", fecha_ini_dia );
            ...
            cs.setInt("V_FECHA_COR_FIN_ANO", fecha_fin_ano );
            cs.setInt("V_FECHA_COR_FIN_MES", fecha_fin_mes );
            cs.setInt("V_FECHA_COR_FIN_DIA", fecha_fin_dia );
            ...
            cs.registerOutParameter("V_LOG", java.sql.Types.VARCHAR);
            ...
            logAvvillas.setText(cs.getString("V_LOG"));
