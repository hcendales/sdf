 ...
 */
public class ReporteLiquidacionExterno extends AbstractPageBean {
     ...
     */
    public ReporteLiquidacionExterno() {
    }
    ...
    public String btReport_action() {
        try {
            ...
            if(this.ddTipoRecaudo.getValue().toString().equals("Seleccione"))
             ...
             if (  checkbox1.getValue() == null && ((String)ddFormato.getValue()).equals("PDF") )
                throw new Exception("Detallado solo en EXCEL");
            ...
            PageReport =  Constants.darPathApp ( this.getFacesContext() ) + "ReportEngine?NameFilter=" + (String)ddFormato.getValue() +
                    ...
                    "&P_MUNICIPIO=" + this.ddMunicipio1.getValue().toString();
            
                                
            if (  checkbox1.getValue() == null  )
               PageReport = PageReport + "&rptfilename=" + "LiquidacionDetallada";
            else
                if ( ddFormato.getValue().toString().equals("CSV") ||
                     ddFormato.getValue().toString().equals("XLS") )
                    PageReport = PageReport + "&rptfilename=" + "Dispersion";
                else
                    PageReport = PageReport + "&rptfilename=" + "Dispersion1";
