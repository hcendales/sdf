...
public class Reports extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ddTipoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("LiquidacionSimitLocal", "SIMIT"), new com.sun.rave.web.ui.model.Option("LiquidacionPolcaLocal", "POLCA")});
        ddFormatoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("XLS", "Excel"), new com.sun.rave.web.ui.model.Option("PDF", "PDF"), new com.sun.rave.web.ui.model.Option("HTML", "HTML")});
    }
    ...
    public String btReport_action() {
        ...
        //PageReport = "http://" + request.getServerName() + ":" + request.getServerPort() + 
        ...
        PageReport = "http://localhost:8084" + 
        
          Constants.darPathApp( this.getFacesContext()) + "ReportEngine?NameFilter=" + (String)ddFormato.getValue() +
                     "&P_FEC_INI=" + formatter.format(fi) +
                     "&P_FEC_FIN=" + formatter.format(ff) +
                     "&rptfilename=" + (String)ddTipo.getValue();
         //http://localhost:8084WASimit/ReportEngine?NameFilter=XLS&P_FEC_INI=dd/MM/yyyy&P_FEC_FIN=dd/MM/yyyy&rptfilename=LiquidacionSimitLocal
        ...
        try {
            ...
            error("Failed to redirect to page " + ex);
        }
