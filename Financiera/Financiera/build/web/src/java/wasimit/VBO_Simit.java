 ...
 */
public class VBO_Simit extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        radioButtonGroup2DefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("D", "Distribucion"), new com.sun.rave.web.ui.model.Option("T", "Traslado Interno"), new com.sun.rave.web.ui.model.Option("F", "Transferir")});
    ...
    public void radioButtonGroup2_processValueChange(ValueChangeEvent event) {
        ...
        if (radioButtonGroup2.getValue().toString().equals("T")) {
           ...
           if (radioButtonGroup2.getValue().toString().equals("F")) {
            if (this.radioButtonGroup1.getValue().toString().equals("L")) {
                label3.setVisible(true);
                calendar3.setVisible(true);
                label4.setVisible(true);
        ...
        try {
            ...
            if (this.textArea1.getText() != null )
                if (this.textArea1.getText().toString().length() > 500 )
                    throw new Exception("Observaciones demasiado largas. Tamaño maximo 500 caracteres");
            ...
            cs = con.prepareCall(Constants.VboSimit);
