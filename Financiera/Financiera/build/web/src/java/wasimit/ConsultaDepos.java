 ...
 */
public class ConsultaDepos extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        ddEstadoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("TO", "TODOS"), new com.sun.rave.web.ui.model.Option("SI", "Sin Autorizar"), new com.sun.rave.web.ui.model.Option("ID", "Autorizados")});
        ...
        dropDown5DefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("PDF", "PDF"), new com.sun.rave.web.ui.model.Option("XLS", "Excel"), new com.sun.rave.web.ui.model.Option("CSV", "Plano")});
        dropDown5DefaultOptions.setSelectedValue("PDF");
        ddEstadoDefaultOptions.setSelectedValue("TO");
        trxsinidentificarDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.trxsinidentificarRowSet2}"));
    }
    ...
    public void init() {
        ...
        try {
            ...
            this.vw_concesionariotrfDataProvider.refresh();
            this.vw_cuentatrfDataProvider.refresh();
            this.vw_municipiotrfDataProvider.refresh();
            this.vw_periodotrfDataProvider.refresh();
            
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(1,"190001");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(2,"XXXXXX");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(3,"999999999");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(4,"999999999");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(5,"TODOS");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(6,"TODOS");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(7,"TO");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(8,"TO");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(9,"0");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(10,"0");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(11,"99");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(12,"99");
    ...
    public String btReporte_action() {
        ...
        try {
            ...
            PageReport = PageReport + "&rptfilename=" + "DepositosRecLocal";
    ...
    public void ddPeriodo_processValueChange(ValueChangeEvent event) {
        ...
        try {
            ...
            //trxsinidentificarDataProvider.close();
            //trxsinidentificarDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.trxsinidentificarRowSet2}"));
            //trxsinidentificarDataProvider.revertChanges();
            //this.trxsinidentificarDataProvider.refresh();
            
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(1,ddPeriodo.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(2,ddPeriodo.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(3,ddCuenta.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(4,ddCuenta.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(5,ddMunicipio.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(6,ddMunicipio.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(7,ddEstado.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(8,ddEstado.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(9,"0");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(10,"0");
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(11,ddCon.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet2().setObject(12,ddCon.getSelected());
            ...
            /*if (this.trxsinidentificarDataProvider.getRowCount() > 0) {
                ...
                int numReg = 0;
                do {
                    trxsinidentificarDataProvider.setValue("idMunicipioNew","00000000");
