 ...
 */
public class ReporteDistOT extends AbstractPageBean {
    ...
    public String btReport_action() {
        try {
            ...
            if (  checkbox.getValue() == null  )
               PageReport = PageReport + "&rptfilename=" + "DistOTDetallada";
            else
               PageReport = PageReport + "&rptfilename=" + "DistOTTotalizada";
