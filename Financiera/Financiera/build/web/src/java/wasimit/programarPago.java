 ...
 */
public class programarPago extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown1DefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("52", "Avvillas"), new com.sun.rave.web.ui.model.Option("51", "Davivienda"), new com.sun.rave.web.ui.model.Option("02", "Popular"), new com.sun.rave.web.ui.model.Option("40", "Agrario")});
        dropDown1DefaultOptions.setSelectedValue("52");
    ...
    private Calendar calendarFecFin1 = new Calendar();

    public Calendar getCalendarFecFin1() {
        return calendarFecFin1;
    }

    public void setCalendarFecFin1(Calendar c) {
        this.calendarFecFin1 = c;
    }
    ...
    protected RequestBean1 getRequestBean1() {
        ...
        try {
            ...
            Date fecha_ini = this.calendarFecIni.getSelectedDate();
            ...
            Date fecha_fin = this.calendarFecFin.getSelectedDate();
            ...
            cs.setInt("p_fec_ini_ano", fecha_ini_ano );
            cs.setInt("p_fec_ini_mes", fecha_ini_mes );
            cs.setInt("p_fec_ini_dia", fecha_ini_dia );
            cs.setInt("p_fec_fin_ano", fecha_fin_ano );
            cs.setInt("p_fec_fin_mes", fecha_fin_mes );
            cs.setInt("p_fec_fin_dia", fecha_fin_dia );
            cs.setString("p_banco", dropDown1.getValue().toString());
            ...
            cs.registerOutParameter("p_codRpta", java.sql.Types.NUMERIC);
