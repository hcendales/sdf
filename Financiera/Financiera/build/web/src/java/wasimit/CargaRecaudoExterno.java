/*
 * CargaRecaudoExterno.java
 *
 * Created on November 20, 2007, 2:48 PM
 * Copyright cristina
 */
package wasimit;
 ...
 */
public class CargaRecaudoExterno extends AbstractPageBean {
    ...
    private Button btCargar = new Button();
    
    public Button getBtCargar() {
        return btCargar;
    }
    
    public void setBtCargar(Button b) {
        this.btCargar = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("CargaRecaudoExterno Initialization Failure", e);
    ...
    public String btCargar_action() {
        // TODO: Process the button click action. Return value is a navigation
        // case name where null will return to the same page.
        try {
            con = getJdbcDataSource().getConnection();
            cs = con.prepareCall(Constants.CarRecExt);
