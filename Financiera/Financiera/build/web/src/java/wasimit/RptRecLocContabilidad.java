 ...
 */
public class RptRecLocContabilidad extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ddBancoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("52", "Avvillas"), new com.sun.rave.web.ui.model.Option("51", "Davivienda"), new com.sun.rave.web.ui.model.Option("02", "Popular"), new com.sun.rave.web.ui.model.Option("40", "Agrario")});
        ddBancoDefaultOptions.setSelectedValue("52");
    }
    ...
    public String btliquidarRL_action() {
        try {
            ...
            PageReport =  Constants.darPathApp ( this.getFacesContext()) + "ReportEngine?NameFilter=CSV1" +
                    ...
                    "&P_BANCO=" + ddBanco.getSelected().toString();
              
            PageReport = PageReport + "&rptfilename=" + "ContabilidadRecaudoLoc";
