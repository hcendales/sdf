...
public class NovDiasDispersion extends AbstractPageBean {
    ...
    */
    ...
    private void _init() throws Exception {
        ...
        vw_municipio_novDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.vw_municipio_novRowSet}"));
    }
    ...
    private CachedRowSetDataProvider vw_municipio_novDataProvider = new CachedRowSetDataProvider();

    public CachedRowSetDataProvider getVw_municipio_novDataProvider() {
        return vw_municipio_novDataProvider;
    }

    public void setVw_municipio_novDataProvider(CachedRowSetDataProvider crsdp) {
        this.vw_municipio_novDataProvider = crsdp;
    }
    ...
    public void destroy() {
        ...
        vw_municipio_novDataProvider.close();
    }
    ...
    public String btActualizar_action() {
        try {
            ...
            cs = con.prepareCall(Constants.NovDiasDispersionAdd);
            ...
            // Se guarda el tipo de novedad
            if (this.btActualizar.getText().toString().equals("Adicionar"))
                cs.setString(++pos, "06");
            else if (this.btActualizar.getText().toString().equals("Actualizar"))
                cs.setString(++pos, "07");
            else
                cs.setString(++pos, "08");
