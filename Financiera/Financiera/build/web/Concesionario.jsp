                ...
                <ui:body binding="#{Concesionario.body1}" focus="form1:tfIdConces" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{Concesionario.form1}" id="form1">
                        ...
                        <ui:button action="#{Concesionario.btAdicionar_action}" binding="#{Concesionario.btAdicionar}" id="btAdicionar"
                            style="left: 479px; top: 1176px; position: absolute; width: 95px" tabIndex="58" text="Adicionar"/>
                        ...
                        <ui:label binding="#{Concesionario.label29}" id="label29" style="left: 264px; top: 1104px; position: absolute; width: 142px" text="Fecha de Prorroga"/>
                        <ui:calendar binding="#{Concesionario.cfecPro}" dateFormatPattern="yyyy-MM-dd" id="cfecPro" style="left: 480px; top: 1104px; position: absolute"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
