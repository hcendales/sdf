                ...
                <ui:body binding="#{AjustesLocal.body1}" focus="form1:ddPeriodo" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{AjustesLocal.form1}" id="form1">
                        ...
                        <ui:button action="#{AjustesLocal.btAgregar_action}" binding="#{AjustesLocal.btAgregar}" id="btAgregar" onClick="btAgregar_action()"
                            style="left: 431px; top: 768px; position: absolute; width: 85px" tabIndex="10" text="Adicionar"/>
                        ...
                        <ui:label binding="#{AjustesLocal.label10}" id="label10" style="left: 264px; top: 672px; position: absolute" text="Motivo del ajuste"/>
                        <ui:textArea binding="#{AjustesLocal.tmotivo1}" id="tmotivo1" style="height: 72px; left: 384px; top: 672px; position: absolute; width: 456px"/>
                        ...
                        <ui:dropDown binding="#{AjustesLocal.ddQuincena}" id="ddQuincena" items="#{AjustesLocal.ddQuincenaDefaultOptions.options}"
                            ...
                            tabIndex="1" valueChangeListener="#{AjustesLocal.ddPeriodo_processValueChange}"/>
                        <ui:checkbox binding="#{AjustesLocal.cbAcuerdo}" id="cbAcuerdo" label="Es acuerdo de pago" style="left: 384px; top: 624px; position: absolute"/>
                        <ui:label binding="#{AjustesLocal.label14}" id="label14" style="left: 264px; top: 624px; position: absolute" text="Acuerdo de pago"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
