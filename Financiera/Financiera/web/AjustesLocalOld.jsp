        ...
        <ui:page binding="#{AjustesLocal.page1}" id="page1">
            <ui:html binding="#{AjustesLocal.html1}" id="html1">
                <ui:head binding="#{AjustesLocal.head1}" id="head1">
                    ...
                    <ui:link binding="#{AjustesLocalOld.link1}" id="link1"/>
                </ui:head>
                <ui:body binding="#{AjustesLocal.body1}" focus="form1:ddPeriodo" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{AjustesLocal.form1}" id="form1">
                        ...
                        <ui:table augmentTitle="false" binding="#{AjustesLocal.table1}" id="table1"
                            style="left: 264px; top: 648px; position: absolute; width: 641px" title="Ajustes" width="641">
                        ...
                        <ui:button action="#{AjustesLocal.btAgregar_action}" binding="#{AjustesLocal.btAgregar}" id="btAgregar" onClick="btAgregar_action()"
                            style="left: 431px; top: 624px; position: absolute; width: 85px" tabIndex="10" text="Adicionar"/>
                        <ui:label binding="#{AjustesLocal.label3}" id="label3" style="left: 264px; top: 480px; position: absolute" text="% Consignado"/>
                        <ui:dropDown binding="#{AjustesLocal.ddPConsignado}" id="ddPConsignado" items="#{AjustesLocal.ddPConsignadoDefaultOptions.options}"
                            style="left: 384px; top: 480px; position: absolute; width: 72px" tabIndex="9"/>
                        <ui:label binding="#{AjustesLocal.label10}" id="label10" style="left: 264px; top: 504px; position: absolute" text="Motivo del ajuste"/>
                        <ui:textArea binding="#{AjustesLocal.tmotivo1}" id="tmotivo1" style="height: 96px; left: 384px; top: 504px; position: absolute; width: 456px"/>
                    </ui:form>
                    <ui:form binding="#{AjustesLocalOld.form1}" id="form1">
                        <ui:staticText binding="#{AjustesLocalOld.stopcion1}" id="stopcion1"/>
                        <ui:dropDown binding="#{AjustesLocalOld.ddPeriodo}" id="ddPeriodo"/>
                        <ui:label binding="#{AjustesLocalOld.label1}" id="label1"/>
                        <ui:table binding="#{AjustesLocalOld.table1}" id="table1"/>
                        <ui:tableRowGroup binding="#{AjustesLocalOld.tableRowGroup1}" id="tableRowGroup1"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn2}" id="tableColumn2"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText2}" id="staticText2"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn3}" id="tableColumn3"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText3}" id="staticText3"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn4}" id="tableColumn4"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText4}" id="staticText4"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn5}" id="tableColumn5"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText5}" id="staticText5"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn6}" id="tableColumn6"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText6}" id="staticText6"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn8}" id="tableColumn8"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText8}" id="staticText8"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn9}" id="tableColumn9"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText9}" id="staticText9"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn10}" id="tableColumn10"/>
                        <ui:staticText binding="#{AjustesLocalOld.staticText10}" id="staticText10"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn1}" id="tableColumn1"/>
                        <ui:button binding="#{AjustesLocalOld.btEliminar}" id="btEliminar"/>
                        <ui:dropDown binding="#{AjustesLocalOld.ddBanco}" id="ddBanco"/>
                        <ui:label binding="#{AjustesLocalOld.label2}" id="label2"/>
                        <ui:dropDown binding="#{AjustesLocalOld.ddMunicipio}" id="ddMunicipio"/>
                        <ui:label binding="#{AjustesLocalOld.label4}" id="label4"/>
                        <ui:dropDown binding="#{AjustesLocalOld.ddTipo}" id="ddTipo"/>
                        <ui:label binding="#{AjustesLocalOld.label5}" id="label5"/>
                        <ui:textField binding="#{AjustesLocalOld.tfCuenta}" id="tfCuenta"/>
                        <ui:label binding="#{AjustesLocalOld.label6}" id="label6"/>
                        <ui:calendar binding="#{AjustesLocalOld.clFechaCorte}" id="clFechaCorte"/>
                        <ui:label binding="#{AjustesLocalOld.label7}" id="label7"/>
                        <ui:calendar binding="#{AjustesLocalOld.clFechaTrn}" id="clFechaTrn"/>
                        <ui:label binding="#{AjustesLocalOld.label8}" id="label8"/>
                        <ui:textField binding="#{AjustesLocalOld.tfValor}" id="tfValor"/>
                        <ui:label binding="#{AjustesLocalOld.label9}" id="label9"/>
                        <ui:button binding="#{AjustesLocalOld.btAgregar}" id="btAgregar"/>
                        <ui:label binding="#{AjustesLocalOld.label3}" id="label3"/>
                        <ui:dropDown binding="#{AjustesLocalOld.ddPConsignado}" id="ddPConsignado"/>
                        <ui:tableColumn binding="#{AjustesLocalOld.tableColumn7}" id="tableColumn7"/>
                        <ui:hyperlink binding="#{AjustesLocalOld.hyperlink1}" id="hyperlink1"/>
                        <ui:label binding="#{AjustesLocalOld.label10}" id="label10"/>
                        <ui:textArea binding="#{AjustesLocalOld.tmotivo1}" id="tmotivo1"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
    </f:view>
    <ui:page binding="#{AjustesLocalOld.page1}" id="page1"/>
    <ui:html binding="#{AjustesLocalOld.html1}" id="html1"/>
    <ui:head binding="#{AjustesLocalOld.head1}" id="head1"/>
    <ui:body binding="#{AjustesLocalOld.body1}" id="body1"/>
</jsp:root>
