                ...
                <ui:body binding="#{IdentificacionDepos.body1}" focus="form1:clFechaIni" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{IdentificacionDepos.form1}" id="form1" virtualFormsConfig="">
                        ...
                        <ui:dropDown binding="#{IdentificacionDepos.ddPeriodo}" id="ddPeriodo"
                            items="#{IdentificacionDepos.vw_periodotrfDataProvider.options['PERIODO,NOMBRE']}" onChange=""
                            style="left: 480px; top: 216px; position: absolute; width: 144px" valueChangeListener="#{IdentificacionDepos.ddPeriodo_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddCuenta}" id="ddCuenta"
                            items="#{IdentificacionDepos.vw_cuentatrfDataProvider.options['CTA,NOMBRE']}" onChange=""
                            style="left: 480px; top: 240px; position: absolute; width: 312px" valueChangeListener="#{IdentificacionDepos.ddCuenta_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddMunicipio}" id="ddMunicipio"
                            items="#{IdentificacionDepos.vw_municipiotrfDataProvider.options['IDMUNICIPIO,NOMBRE']}" onChange=""
                            style="left: 480px; top: 264px; position: absolute; width: 312px" valueChangeListener="#{IdentificacionDepos.ddMunicipio_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddEstado}" id="ddEstado" items="#{IdentificacionDepos.ddEstadoDefaultOptions.options}"
                            onChange="" style="left: 480px; top: 168px; position: absolute; width: 240px" valueChangeListener="#{IdentificacionDepos.ddEstado_processValueChange}"/>
                        ...
                        <ui:dropDown binding="#{IdentificacionDepos.ddCon}" id="ddCon"
                            items="#{IdentificacionDepos.vw_concesionariotrfDataProvider.options['IDCON,NOMBRE']}" onChange=""
                        ...
                        <ui:label binding="#{IdentificacionDepos.label4}" id="label4"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
    </f:view>
    <ui:form binding="#{IdentificacionDepos.form1}" id="form1"/>
</jsp:root>
