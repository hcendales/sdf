            ...
            <ui:html binding="#{ConsNovedadDevolucion.html1}" id="html1">
                ...
                <ui:body binding="#{ConsNovedadDevolucion.body1}" focus="form1:ddMunicipio" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{ConsNovedadDevolucion.form1}" id="form1">
                        ...
                        <ui:label binding="#{ConsNovedadDevolucion.lbBanco19}" id="lbBanco19" style="left: 312px; top: 1152px; position: absolute" text="Fecha Activacion"/>
                        <ui:calendar binding="#{ConsNovedadDevolucion.cfechaAct}" dateFormatPattern="yyyy-MM-dd" disabled="true" id="cfechaAct"
                            style="left: 504px; top: 1152px; position: absolute" tabIndex="24"/>
                        <ui:label binding="#{ConsNovedadDevolucion.label8}" id="label8" style="color: red; left: 288px; top: 1128px; position: absolute" text="ACTIVACION"/>
                        ...
                        <ui:button action="#{ConsNovedadDevolucion.btReimprimir_action}" binding="#{ConsNovedadDevolucion.btReimprimir}" id="btReimprimir"
                            ...
                            style="left: 455px; top: 1200px; position: absolute; width: 95px" text="Aprobar"/>
                        <ui:button action="#{ConsNovedadDevolucion.btAnular_action}" binding="#{ConsNovedadDevolucion.btAnular}" id="btAnular"
                            ...
                            style="left: 623px; top: 1200px; position: absolute; width: 95px" tabIndex="15" text="Rechazar"/>
                        ...
                        <ui:label binding="#{ConsNovedadDevolucion.lbBanco25}" id="lbBanco25" style="left: 312px; top: 1080px; position: absolute" text="Valor Metrotransito - Barranquilla"/>
                        <ui:textField binding="#{ConsNovedadDevolucion.txtVlrTercero}" disabled="true" id="txtVlrTercero" maxLength="10"
                            style="left: 504px; top: 1080px; position: absolute; width: 144px" tabIndex="23"/>
                        <ui:label binding="#{ConsNovedadDevolucion.lbBanco26}" id="lbBanco26" style="left: 312px; top: 648px; position: absolute" text="Fecha Comparendo"/>
                        <ui:calendar binding="#{ConsNovedadDevolucion.cfechaCom}" dateFormatPattern="yyyy-MM-dd" disabled="true" id="cfechaCom"
                            style="left: 456px; top: 648px; position: absolute" tabIndex="24"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
