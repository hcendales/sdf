            ...
            <ui:html binding="#{RptDevolAplic.html1}" id="html1">
                ...
                <ui:body binding="#{RptDevolAplic.body1}" focus="form1:calendarFecIni" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{RptDevolAplic.form1}" id="form1">
                        ...
                        <ui:calendar binding="#{RptDevolAplic.calendarFecIni}" dateFormatPattern="yyyy-MM-dd" id="calendarFecIni" label="Fecha Novedad Inicial"
                        ...
                        <ui:calendar binding="#{RptDevolAplic.calendarFecFin}" dateFormatPattern="yyyy-MM-dd" id="calendarFecFin" label="Fecha Novedad Final"
