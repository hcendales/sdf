...
prompt Created on martes, 28 de junio de 2011 by user
set feedback off
set define off
...
prompt Disabling foreign key constraints for NOVDEVOLUCION...
alter table NOVDEVOLUCION disable constraint FK_NOVDEVBANCO;
alter table NOVDEVOLUCION disable constraint FK_NOVDEVCONCES;
alter table NOVDEVOLUCION disable constraint FK_NOVDEVMUNICIPIO;
prompt Loading NOVDEVOLUCION...
prompt Table is empty
prompt Enabling foreign key constraints for NOVDEVOLUCION...
alter table NOVDEVOLUCION enable constraint FK_NOVDEVBANCO;
alter table NOVDEVOLUCION enable constraint FK_NOVDEVCONCES;
alter table NOVDEVOLUCION enable constraint FK_NOVDEVMUNICIPIO;
set feedback on
set define on
prompt Done.
