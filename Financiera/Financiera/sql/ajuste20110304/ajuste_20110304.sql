...
-- Created by user on 04/03/2011, 8:49:20 --
--------------------------------------------

spool ajuste_20110304.log
...
create or replace package body pk_proc is
  ...
  BEGIN
    ...
    p_error := p_error || ' Registros cruzados:' || v_valida;
      ...
      ELSE
        ...
        ELSE
          ...
          sp_envionotificacion(gruporecibe => 4,
                               grupocopia  => -1,
                               asunto      => 'Notificación de Novedad de Municipio:  ' ||
                                              p_novedad,
      ...
      BEGIN
        ...
        if (p_estado = 'ANULADA') THEN
          sp_envionotificacion(gruporecibe => 3,
                               grupocopia  => -1,
                               asunto      => 'Notificación de ANULACION Novedad de Municipio:  ' ||
                                              p_tiponov || '-' ||
                                              p_numeronov,
  ...
  BEGIN
    ...
    ELSE
      ...
      ELSE
        ...
        sp_envionotificacion(gruporecibe => 4,
                             grupocopia  => -1,
                             asunto      => 'Notificación de Novedad Tercero:  ' ||
                                            p_novedad,
  ...
  BEGIN
    ...
    ELSE
      ...
      ELSE
        ...
        sp_envionotificacion(gruporecibe => 4,
                             grupocopia  => -1,
                             asunto      => 'Notificación de Novedad Dias de Dispersion Municipio:  ' ||
                                            p_novedad,
