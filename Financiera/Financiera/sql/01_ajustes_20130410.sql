...
-- Created by SEVEN on 10/04/2013, 11:16:49 --
----------------------------------------------

set define off
spool 01_ajustes_20130410.log

prompt
prompt Creating table SOPORTEDEVOLUCION
prompt ================================
prompt
create table SOPORTEDEVOLUCION
(
  numeronov        NUMBER,
...
;
comment on column SOPORTEDEVOLUCION.numeronov
  is 'numero novedad devolucion';
comment on column SOPORTEDEVOLUCION.id_documento
  is 'numero de documento';
comment on column SOPORTEDEVOLUCION.nombredocumento
  is 'nombre documento';
comment on column SOPORTEDEVOLUCION.nombrearchivo
  is 'nombre del archivo';
comment on column SOPORTEDEVOLUCION.extensionarchivo
  is 'extencion del archivo';
comment on column SOPORTEDEVOLUCION.datosarchivo
  is 'contenido del archivo';
comment on column SOPORTEDEVOLUCION.usuariocargue
  is 'usuario que carga';
comment on column SOPORTEDEVOLUCION.fechacargue
  is 'fecha de carga';
alter table SOPORTEDEVOLUCION
  add constraint PK_SOPORTEDEVOLUCION primary key (ID_DOCUMENTO);

prompt
prompt Creating view VW_SOPORTEDEVOLUCION
prompt ==================================
prompt
create or replace force view vw_soportedevolucion as
select numeronov, id_documento, nombredocumento, nombrearchivo, extensionarchivo, usuariocargue, fechacargue from soportedevolucion;
