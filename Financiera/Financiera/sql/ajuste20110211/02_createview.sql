...
-- Created by user on 04/02/2011, 16:39:13 --
---------------------------------------------

spool 02_createview.log

prompt
prompt Creating view VW_CONCEPTOPAGO
prompt =============================
prompt
create or replace view simit.vw_conceptopago as
...
prompt =============================
prompt
create or replace view simit.vw_cuentaorigen as
...
prompt ================================
prompt
create or replace view simit.vw_distotdetallado as
