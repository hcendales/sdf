...
-- Created by user on 04/04/2011, 14:41:09 --
---------------------------------------------

spool 03_pk_param.log
...
prompt ==============================
prompt
create or replace package body pk_param is
  ...
  BEGIN
    ...
    sp_log(p_usuario,
           ...
           p_liq1_idbanco || '-' || p_liq1_tipocuenta || '-' || p_liq1_nit_c || '-' ||
           p_liq1_cuenta || '-' ||

           p_liq2_idbanco || '-' || p_liq2_tipocuenta || '-' || p_liq2_nit_c || '-' ||
           p_liq2_cuenta || '-' ||

           p_liq3_idbanco || '-' || p_liq3_tipocuenta || '-' || p_liq3_nit_c || '-' ||
           p_liq3_cuenta || '-' ||

           p_liq4_idbanco || '-' || p_liq4_tipocuenta || '-' || p_liq4_nit_c || '-' ||
           p_liq4_cuenta || '-' ||
    ...
    IF P_ERROR is null THEN
      ...
      BEGIN
        ...
        select idbanco, nit_c, tipocuenta, desencriptar(cuenta)
          into p_liq1_idbanco, p_liq1_nit_c, p_liq1_tipocuenta, p_liq1_cuenta
        ...
        BEGIN   
        select idbanco, nit_c, tipocuenta, desencriptar(cuenta)
          into p_liq2_idbanco, p_liq2_nit_c, p_liq2_tipocuenta, p_liq2_cuenta
          from cta_dispersion_concesionario
         where idconcesionario = p_idconcesionario
           and idbancorec = p_idbancorec
           and idconcepto = 8;
        ...
        BEGIN   
        select idbanco, nit_c, tipocuenta, desencriptar(cuenta)
          into p_liq3_idbanco, p_liq3_nit_c, p_liq3_tipocuenta, p_liq3_cuenta
          from cta_dispersion_concesionario
         where idconcesionario = p_idconcesionario
           and idbancorec = p_idbancorec
           and idconcepto = 9;
        ...
        BEGIN
        select idbanco, nit_c, tipocuenta, desencriptar(cuenta)
          into p_liq4_idbanco, p_liq4_nit_c, p_liq4_tipocuenta, p_liq4_cuenta
          from cta_dispersion_concesionario
         where idconcesionario = p_idconcesionario
           and idbancorec = p_idbancorec
           and idconcepto = 10;
