                ...
                <ui:body binding="#{IdentificacionDepos.body1}" focus="form1:clFechaIni" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{IdentificacionDepos.form1}" id="form1" virtualFormsConfig="">
                        ...
                        <ui:button action="#{IdentificacionDepos.btReporte_action}" binding="#{IdentificacionDepos.btReporte}" id="btReporte"
                            style="height: 24px; left: 671px; top: 360px; position: absolute; width: 144px" tabIndex="3" text="Generar Reporte"/>
                        ...
                        <ui:label binding="#{IdentificacionDepos.label4}" id="label4" style="height: 22px; left: 336px; top: 288px; position: absolute" text="Valor"/>
                        <ui:table augmentTitle="false" binding="#{IdentificacionDepos.table1}" clearSortButton="true" id="table1" paginateButton="true"
                            paginationControls="true" sortPanelToggleButton="true" style="left: 336px; top: 432px; position: absolute; width: 1920px"
                            ...
                            <ui:tableRowGroup binding="#{IdentificacionDepos.tableRowGroup1}" emptyDataMsg="No hay registros" id="tableRowGroup1" rows="50"
                                ...
                                <ui:tableColumn binding="#{IdentificacionDepos.tableColumn2}" headerText="Procesar" id="tableColumn2" sort="ACTUALIZAR">
                        ...
                        <ui:label binding="#{IdentificacionDepos.label5}" id="label5"
                            style="height: 22px; left: 336px; top: 168px; position: absolute; width: 46px" text="Estado"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddPeriodo}" id="ddPeriodo"
                            items="#{IdentificacionDepos.vw_periodotrfDataProvider.options['PERIODO,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddPeriodo');" style="left: 480px; top: 216px; position: absolute; width: 144px" valueChangeListener="#{IdentificacionDepos.ddPeriodo_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddCuenta}" id="ddCuenta"
                            items="#{IdentificacionDepos.vw_cuentatrfDataProvider.options['CTA,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddCuenta');" style="left: 480px; top: 240px; position: absolute; width: 312px" valueChangeListener="#{IdentificacionDepos.ddCuenta_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddMunicipio}" id="ddMunicipio"
                            items="#{IdentificacionDepos.vw_municipiotrfDataProvider.options['IDMUNICIPIO,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddMunicipio');" style="left: 480px; top: 264px; position: absolute; width: 312px" valueChangeListener="#{IdentificacionDepos.ddMunicipio_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddEstado}" id="ddEstado" items="#{IdentificacionDepos.ddEstadoDefaultOptions.options}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddEstado');" style="left: 480px; top: 168px; position: absolute; width: 240px" valueChangeListener="#{IdentificacionDepos.ddEstado_processValueChange}"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddValor}" converter="#{IdentificacionDepos.ddValorConverter}" id="ddValor"
                            items="#{IdentificacionDepos.vw_valortrfDataProvider.options['VALORTRX,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddValor');" style="left: 480px; top: 288px; position: absolute; width: 240px" valueChangeListener="#{IdentificacionDepos.ddValor_processValueChange}"/>
                        <ui:label binding="#{IdentificacionDepos.label6}" id="label6" style="height: 22px; left: 336px; top: 144px; position: absolute" text="Concesionario Zonal"/>
                        <ui:button action="#{IdentificacionDepos.bsalvar_action}" binding="#{IdentificacionDepos.bsalvar}" disabled="true" id="bsalvar"
                            ...
                            style="height: 24px; left: 503px; top: 360px; position: absolute; width: 144px" text="Procesar Cambios"/>
                        <ui:dropDown binding="#{IdentificacionDepos.ddCon}" id="ddCon"
                            items="#{IdentificacionDepos.vw_concesionariotrfDataProvider.options['IDCON,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddCon');"
                            style="height: 24px; left: 480px; top: 144px; position: absolute; width: 240px" valueChangeListener="#{IdentificacionDepos.ddCon_processValueChange}"/>
                        <ui:button action="#{IdentificacionDepos.biniIdentificar_action}" binding="#{IdentificacionDepos.biniIdentificar}" id="biniIdentificar"
                            style="height: 24px; left: 335px; top: 360px; position: absolute; width: 144px" text="Iniciar Identificacion"/>
                        <ui:label binding="#{IdentificacionDepos.label7}" id="label7"
                            style="height: 22px; left: 840px; top: 360px; position: absolute; width: 46px" text="Formato"/>
                        <ui:dropDown binding="#{IdentificacionDepos.dropDown5}" id="dropDown5" items="#{IdentificacionDepos.dropDown5DefaultOptions.options}" style="height: 24px; left: 912px; top: 360px; position: absolute; width: 96px"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
