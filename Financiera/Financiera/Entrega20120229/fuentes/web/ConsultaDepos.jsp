                ...
                <ui:body binding="#{ConsultaDepos.body1}" focus="form1:clFechaIni" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{ConsultaDepos.form1}" id="form1" virtualFormsConfig="">
                        ...
                        <ui:button action="#{ConsultaDepos.btReporte_action}" binding="#{ConsultaDepos.btReporte}" id="btReporte"
                            style="height: 24px; left: 335px; top: 360px; position: absolute; width: 144px" tabIndex="3" text="Generar Reporte"/>
                        ...
                        <ui:label binding="#{ConsultaDepos.label4}" id="label4" style="height: 22px; left: 336px; top: 288px; position: absolute" text="Valor"/>
                        <ui:table augmentTitle="false" binding="#{ConsultaDepos.table1}" clearSortButton="true" id="table1" paginateButton="true"
                            ...
                            <ui:tableRowGroup binding="#{ConsultaDepos.tableRowGroup1}" emptyDataMsg="No hay registros" id="tableRowGroup1" rows="50"
                                ...
                                <ui:tableColumn binding="#{ConsultaDepos.tableColumn17}" headerText="Municipio Asignado" id="tableColumn17">
                                ...
                                <ui:tableColumn binding="#{ConsultaDepos.tableColumn5}" headerText="Tipo Asignado" id="tableColumn5">
                        ...
                        <ui:dropDown binding="#{ConsultaDepos.ddPeriodo}" id="ddPeriodo"
                            items="#{ConsultaDepos.vw_periodotrfDataProvider.options['PERIODO,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddPeriodo');" style="left: 480px; top: 216px; position: absolute; width: 144px" valueChangeListener="#{ConsultaDepos.ddPeriodo_processValueChange}"/>
                        <ui:dropDown binding="#{ConsultaDepos.ddCuenta}" id="ddCuenta" items="#{ConsultaDepos.vw_cuentatrfDataProvider.options['CTA,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddCuenta');" style="left: 480px; top: 240px; position: absolute; width: 312px" valueChangeListener="#{ConsultaDepos.ddCuenta_processValueChange}"/>
                        <ui:dropDown binding="#{ConsultaDepos.ddMunicipio}" id="ddMunicipio"
                            items="#{ConsultaDepos.vw_municipiotrfDataProvider.options['IDMUNICIPIO,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddMunicipio');" style="left: 480px; top: 264px; position: absolute; width: 312px" valueChangeListener="#{ConsultaDepos.ddMunicipio_processValueChange}"/>
                        <ui:dropDown binding="#{ConsultaDepos.ddEstado}" id="ddEstado" items="#{ConsultaDepos.ddEstadoDefaultOptions.options}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddEstado');" style="left: 480px; top: 168px; position: absolute; width: 240px" valueChangeListener="#{ConsultaDepos.ddEstado_processValueChange}"/>
                        <ui:dropDown binding="#{ConsultaDepos.ddValor}" converter="#{ConsultaDepos.ddValorConverter}" id="ddValor"
                            items="#{ConsultaDepos.vw_valortrfDataProvider.options['VALORTRX,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddValor');" style="left: 480px; top: 288px; position: absolute; width: 240px" valueChangeListener="#{ConsultaDepos.ddValor_processValueChange}"/>
                        ...
                        <ui:dropDown binding="#{ConsultaDepos.ddCon}" id="ddCon"
                            items="#{ConsultaDepos.vw_concesionariotrfDataProvider.options['IDCON,NOMBRE']}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddCon');"
                            style="height: 24px; left: 480px; top: 144px; position: absolute; width: 240px" valueChangeListener="#{ConsultaDepos.ddCon_processValueChange}"/>
                        <ui:label binding="#{ConsultaDepos.label7}" id="label7" style="height: 22px; left: 504px; top: 360px; position: absolute; width: 46px" text="Formato"/>
                        <ui:dropDown binding="#{ConsultaDepos.dropDown5}" id="dropDown5" items="#{ConsultaDepos.dropDown5DefaultOptions.options}" style="height: 24px; left: 576px; top: 360px; position: absolute; width: 96px"/>
                    </ui:form>
                </ui:body>
            </ui:html>
        </ui:page>
