                ...
                <ui:body binding="#{SoportesAjustesLocal.body1}" focus="form1:forma" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{SoportesAjustesLocal.form1}" id="form1">
                        ...
                        <ui:button action="#{SoportesAjustesLocal.btAgregar_action}" binding="#{SoportesAjustesLocal.btAgregar}" id="btAgregar"
                            onClick="btAgregar_action()" style="left: 383px; top: 672px; position: absolute; width: 85px" tabIndex="10" text="Adjuntar"/>
                        ...
                        <ui:upload binding="#{SoportesAjustesLocal.fileUpload1}" id="fileUpload1" style="left: 384px; top: 576px; position: absolute"/>
                        ...
                        <ui:textField binding="#{SoportesAjustesLocal.tfNombre}" id="tfNombre" style="left: 384px; top: 624px; position: absolute"/>
                        <ui:label binding="#{SoportesAjustesLocal.label10}" id="label10" style="left: 264px; top: 624px; position: absolute" text="Nombre documento"/>
                        <ui:label binding="#{SoportesAjustesLocal.label11}" id="label11" style="left: 264px; top: 576px; position: absolute" text="Archivo"/>
                        <ui:table augmentTitle="false" binding="#{SoportesAjustesLocal.table1}" id="table1"
                            style="left: 264px; top: 720px; position: absolute; width: 588px" title="Documentos" width="588">
