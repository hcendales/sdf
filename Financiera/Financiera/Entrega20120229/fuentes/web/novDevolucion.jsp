                ...
                <ui:body binding="#{novDevolucion.body1}" focus="form1:ddMunicipio" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{novDevolucion.form1}" id="form1">
                        ...
                        <ui:button action="#{novDevolucion.btAdicionar_action}" binding="#{novDevolucion.btAdicionar}" id="btAdicionar"
                            onClick="btActualizar_action()" style="left: 551px; top: 1224px; position: absolute; width: 95px" tabIndex="34" text="Crear Novedad"/>
                        ...
                        <ui:label binding="#{novDevolucion.lbBanco6}" id="lbBanco6" style="left: 312px; top: 648px; position: absolute" text="Motivo Devolucion"/>
                        <ui:label binding="#{novDevolucion.lbBanco7}" id="lbBanco7" style="left: 312px; top: 696px; position: absolute" text="Valor Devolucion"/>
                        <ui:label binding="#{novDevolucion.label7}" id="label7" style="color: red; left: 312px; top: 816px; position: absolute; width: 312px" text="VALORES DEVOLUCION "/>
                        <ui:label binding="#{novDevolucion.lbBanco8}" id="lbBanco8" style="left: 312px; top: 840px; position: absolute" text="Concesionario"/>
                        <ui:label binding="#{novDevolucion.lbBanco9}" id="lbBanco9" style="left: 312px; top: 864px; position: absolute" text="FCM"/>
                        <ui:label binding="#{novDevolucion.lbBanco10}" id="lbBanco10" style="left: 312px; top: 888px; position: absolute" text="Fondo Cobertura Simit"/>
                        <ui:label binding="#{novDevolucion.lbBanco11}" id="lbBanco11" style="left: 312px; top: 912px; position: absolute" text="Fondo Cobertura Concesionario"/>
                        <ui:label binding="#{novDevolucion.lbBanco12}" id="lbBanco12" style="left: 312px; top: 936px; position: absolute" text="Equilibrio Economico"/>
                        <ui:label binding="#{novDevolucion.lbBanco13}" id="lbBanco13" style="left: 312px; top: 1032px; position: absolute" text="SEVIAL 2.7%"/>
                        <ui:label binding="#{novDevolucion.lbBanco14}" id="lbBanco14" style="left: 312px; top: 984px; position: absolute" text="POLCA"/>
                        <ui:label binding="#{novDevolucion.lbBanco15}" id="lbBanco15" style="left: 312px; top: 1008px; position: absolute" text="FCM POLCA 1.8%"/>
                        <ui:label binding="#{novDevolucion.lbBanco16}" id="lbBanco16" style="left: 312px; top: 1080px; position: absolute" text="Municipio"/>
                        <ui:label binding="#{novDevolucion.lbBanco17}" id="lbBanco17" style="left: 312px; top: 1104px; position: absolute" text="Contravencional  FCM"/>
                        <ui:label binding="#{novDevolucion.lbBanco18}" id="lbBanco18" style="left: 312px; top: 1128px; position: absolute" text="Contravencional  Concesionario"/>
                        ...
                        <ui:textField binding="#{novDevolucion.txtMotivo}" disabled="true" id="txtMotivo" maxLength="50"
                            style="left: 456px; top: 672px; position: absolute; width: 432px" tabIndex="16"/>
                        <ui:textField binding="#{novDevolucion.txtValorDev}" id="txtValorDev" maxLength="7"
                            style="left: 456px; top: 696px; position: absolute; width: 144px" tabIndex="17"/>
                        <ui:textField binding="#{novDevolucion.txtValorConces}" id="txtValorConces" maxLength="10"
                            style="left: 504px; top: 840px; position: absolute; width: 144px" tabIndex="22"/>
                        <ui:textField binding="#{novDevolucion.txtValorFcm}" id="txtValorFcm" maxLength="10"
                            style="left: 504px; top: 864px; position: absolute; width: 144px" tabIndex="23"/>
                        ...
                        <ui:textField binding="#{novDevolucion.txtValorPolca}" id="txtValorPolca" maxLength="10"
                            style="left: 504px; top: 984px; position: absolute; width: 144px" tabIndex="27"/>
                        <ui:textField binding="#{novDevolucion.txtValorFcmPolca}" id="txtValorFcmPolca" maxLength="10"
                            style="left: 504px; top: 1008px; position: absolute; width: 144px" tabIndex="28"/>
                        <ui:textField binding="#{novDevolucion.txtValorsevial27}" id="txtValorsevial27" maxLength="10"
                            style="left: 504px; top: 1032px; position: absolute; width: 144px" tabIndex="29"/>
                        <ui:textField binding="#{novDevolucion.txtValorMunicipio}" id="txtValorMunicipio" maxLength="10"
                            style="left: 504px; top: 1080px; position: absolute; width: 144px" tabIndex="30"/>
                        <ui:textField binding="#{novDevolucion.txtValorContravFcm}" id="txtValorContravFcm" maxLength="10"
                            style="left: 504px; top: 1104px; position: absolute; width: 144px" tabIndex="31"/>
                        <ui:textField binding="#{novDevolucion.txtValorContravConc}" id="txtValorContravConc" maxLength="10"
                            style="left: 504px; top: 1128px; position: absolute; width: 144px" tabIndex="32"/>
                        <ui:label binding="#{novDevolucion.lbBanco19}" id="lbBanco19" style="left: 312px; top: 1176px; position: absolute" text="Fecha Activacion"/>
                        <ui:calendar binding="#{novDevolucion.cfechaAct}" dateFormatPattern="yyyy-MM-dd" id="cfechaAct"
                            style="left: 504px; top: 1176px; position: absolute" tabIndex="33"/>
                        <ui:label binding="#{novDevolucion.label8}" id="label8" style="color: red; left: 288px; top: 1152px; position: absolute" text="ACTIVACION"/>
                        <ui:button action="#{novDevolucion.bsugerirValor_action}" binding="#{novDevolucion.bsugerirValor}" id="bsugerirValor"
                            style="left: 455px; top: 792px; position: absolute; width: 128px" tabIndex="21" text="Sugerir Valores"/>
                        ...
                        <ui:label binding="#{novDevolucion.lbBanco21}" id="lbBanco21" style="left: 312px; top: 720px; position: absolute" text="Valor Adicional"/>
                        <ui:textField binding="#{novDevolucion.txtValorAdicional}" id="txtValorAdicional" maxLength="7"
                            style="left: 456px; top: 720px; position: absolute; width: 144px" tabIndex="18"/>
                        <ui:checkbox binding="#{novDevolucion.civa}" id="civa" label="Valores incluyen IVA" selectedValue="S"
                            style="left: 456px; top: 744px; position: absolute" tabIndex="19"/>
                        <ui:checkbox binding="#{novDevolucion.crete}" id="crete" label="Valores incluyen retefuente" selectedValue="S"
                            style="left: 624px; top: 744px; position: absolute; width: 168px" tabIndex="20"/>
                        ...
                        <ui:dropDown binding="#{novDevolucion.ddMotivo}" id="ddMotivo" items="#{novDevolucion.ddMotivoDefaultOptions.options}"
                            onChange="common_timeoutSubmitForm(this.form, 'ddMotivo');" style="left: 456px; top: 648px; position: absolute; width: 312px"
                            tabIndex="15" valueChangeListener="#{novDevolucion.ddMotivo_processValueChange}"/>
                        ...
                        <ui:label binding="#{novDevolucion.lbBanco24}" id="lbBanco24" style="left: 312px; top: 960px; position: absolute" text="SEVIAL 3.0%"/>
                        <ui:textField binding="#{novDevolucion.txtValorsevial3}" id="txtValorsevial3" maxLength="10"
                            style="left: 504px; top: 960px; position: absolute; width: 144px" tabIndex="29"/>
                        <ui:calendar binding="#{novDevolucion.cfechaLiq}" dateFormatPattern="yyyy-MM-dd" id="cfechaLiq"
                            style="left: 456px; top: 600px; position: absolute" tabIndex="33"/>
