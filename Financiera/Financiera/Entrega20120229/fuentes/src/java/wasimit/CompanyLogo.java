...
public class CompanyLogo extends AbstractFragmentBean {
    ...
    public void init() {
        ...
        if (Constants.AMBIENTE.equals("PROD")) {
            this.image3.setUrl("/resources/logo_simit.gif");
            this.image2.setUrl("/resources/logo_fcm.gif");
        } else
        {
            this.image3.setUrl("/resources/logo_simit1.gif");
            this.image2.setUrl("/resources/logo_fcm1.gif");
        }
