 ...
 */
public class ReporteDistOTIde extends AbstractPageBean {
    ...
    public String btReport_action() {
        try {
            ...
            PageReport =  Constants.darPathApp(this.getFacesContext()) + "ReportEngine?NameFilter=PDF" +
                    "&P_IDENTIFICACION=" + textField1.getText();
            
                                
            PageReport = PageReport + "&rptfilename=" + "DistOTDetalladaIde";
