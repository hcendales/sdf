 ...
 */
public class ConsNovedadesMunicipio extends AbstractPageBean {
    ...
    private CachedRowSetDataProvider novmunicipioDataProvider = new CachedRowSetDataProvider();
    
    public CachedRowSetDataProvider getNovmunicipioDataProvider() {
        return novmunicipioDataProvider;
    }
    
    public void setNovmunicipioDataProvider(CachedRowSetDataProvider crsdp) {
        this.novmunicipioDataProvider = crsdp;
    }
    ...
    private DropDown ddMunicipio1 = new DropDown();
    
    public DropDown getDdMunicipio1() {
        return ddMunicipio1;
    }
    
    public void setDdMunicipio1(DropDown dd) {
        this.ddMunicipio1 = dd;
    }
    ...
    public void prerender() {
        ...
        try {
            ...
            novmunicipioDataProvider.refresh();
        } catch (Exception e) {
     ...
     */
    public void destroy() {
        novmunicipioDataProvider.close();
 ...
 */
    ...
    public void ddEstado_processValueChange(ValueChangeEvent vce) {
        ...
        try {
            ...
            if (ddMunicipio1.getSelected() == null ) {
                getSessionBean1().getNovmunicipioRowSet1().setObject(
                        3, "00000000");
                getSessionBean1().getNovmunicipioRowSet1().setObject(
                        4, "00000000");
                ...
                getSessionBean1().getNovmunicipioRowSet1().setObject(
                        3, this.ddMunicipio1.getSelected().toString());
                getSessionBean1().getNovmunicipioRowSet1().setObject(
                        4, this.ddMunicipio1.getSelected().toString());
            }
