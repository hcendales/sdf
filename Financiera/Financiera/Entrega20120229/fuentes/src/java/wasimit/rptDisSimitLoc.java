 ...
 */
public class rptDisSimitLoc extends AbstractPageBean {
    ...
    public String btReport_action() {
        try {
            ...
            PageReport =  Constants.darPathApp() + "ReportEngine?NameFilter=" + (String)ddFormato.getValue() +
                    ...
                    "&rptfilename=" + "DispersionSimitLocal";
    ...
    public void ddFormato_processValueChange(ValueChangeEvent event) {
