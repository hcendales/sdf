 ...
 */
public class DefDptal extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        departamentalDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.departamentalRowSet}"));
    }
    ...
    private CachedRowSetDataProvider departamentalDataProvider = new CachedRowSetDataProvider();
    
    public CachedRowSetDataProvider getDepartamentalDataProvider() {
        return departamentalDataProvider;
    }
    
    public void setDepartamentalDataProvider(CachedRowSetDataProvider crsdp) {
        this.departamentalDataProvider = crsdp;
    }
    ...
    public void init() {
        ...
        try {
            ...
            getSessionBean1().getDepartamentalRowSet().setObject(
                    1, "00000000" );
    ...
    public void destroy() {
        ...
        departamentalDataProvider.close();
    }
    ...
    public String button2_action() {
        ...
        try {
            ...
            cs = con.prepareCall(Constants.iDptal);
            
            cs.setString(++pos,this.dropDown1.getSelected().toString());
            cs.setString(++pos,this.dropDown2.getSelected().toString());
            ...
            info(resultado);
            getSessionBean1().getDepartamentalRowSet().setObject(
                    1, this.dropDown1.getSelected().toString() );
            
            this.departamentalDataProvider.refresh();
    ...
    public String button1_action() {
        ...
        try {
            ...
            con = getJdbcDataSource().getConnection();
            cs = con.prepareCall(Constants.dDptal);
            
            cs.setString(++pos,this.staticText1.getValue().toString());
            cs.setString(++pos,this.staticText2.getValue().toString());
