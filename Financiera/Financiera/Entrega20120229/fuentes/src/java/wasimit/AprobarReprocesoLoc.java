 ...
 */
public class AprobarReprocesoLoc extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        rbTipoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("L", "Distribucion "), new com.sun.rave.web.ui.model.Option("T", "Transferir"), new com.sun.rave.web.ui.model.Option("B", "Envio Bancos")});
        rbTipoDefaultOptions.setSelectedValue("L");
        dropDown1DefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("52", "Avvillas"), new com.sun.rave.web.ui.model.Option("99", "Otros bancos")});
    ...
    private Calendar clFechaIni1 = new Calendar();

    public Calendar getClFechaIni1() {
        return clFechaIni1;
    }

    public void setClFechaIni1(Calendar c) {
        this.clFechaIni1 = c;
    }
    ...
    public String btLiquidar_action() {
        ...
        try {
            ...
            cs = con.prepareCall(Constants.AprobarRepLoc);
            ...
            Date fecha_fin = this.clFechaIni1.getSelectedDate();
            ...
            cs.setString(++pos, this.dropDown1.getValue().toString());
