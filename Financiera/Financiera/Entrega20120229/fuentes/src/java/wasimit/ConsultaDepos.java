...
public class ConsultaDepos extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        trxsinidentificarDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.trxsinidentificarRowSet1}"));
    ...
    public void init() {
        ...
        try {
            ...
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(1,"999999");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(2,"999999");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(3,"999999999");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(4,"999999999");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(5,"TODOS");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(6,"TODOS");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(7,"TO");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(8,"TO");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(9,"0");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(10,"0");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(11,"99");
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(12,"99");
    ...
    public void ddPeriodo_processValueChange(ValueChangeEvent event) {
        ...
        try {
            ...
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(1,ddPeriodo.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(2,ddPeriodo.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(3,ddCuenta.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(4,ddCuenta.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(5,ddMunicipio.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(6,ddMunicipio.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(7,ddEstado.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(8,ddEstado.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(9,ddValor.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(10,ddValor.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(11,ddCon.getSelected());
            getSessionBean1().getTrxsinidentificarRowSet1().setObject(12,ddCon.getSelected());
