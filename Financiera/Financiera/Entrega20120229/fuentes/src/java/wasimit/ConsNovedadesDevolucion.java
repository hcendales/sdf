 ...
 */
public class ConsNovedadesDevolucion extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        novmunicipioDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.novdevolucionRowSet1}"));
     ...
     */
    public ConsNovedadesDevolucion() {
    }
