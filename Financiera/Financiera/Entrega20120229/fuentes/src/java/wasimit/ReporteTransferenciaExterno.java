...
public class ReporteTransferenciaExterno extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        ddBancoDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("99", "TODOS"), new com.sun.rave.web.ui.model.Option("52", "BANCO AV VILLAS"), new com.sun.rave.web.ui.model.Option("50", "GRANBANCO S.A."), new com.sun.rave.web.ui.model.Option("40", "AGRARIO"), new com.sun.rave.web.ui.model.Option("02", "POPULAR")});
        tipoRptDefaultOptions.setOptions(new com.sun.rave.web.ui.model.Option[] {new com.sun.rave.web.ui.model.Option("S", "Sin fecha de corte"), new com.sun.rave.web.ui.model.Option("N", "Con fecha de corte")});
        tipoRptDefaultOptions.setSelectedValue("S");
    }
    ...
    private RadioButtonGroup tipoRpt = new RadioButtonGroup();
    
    public RadioButtonGroup getTipoRpt() {
        return tipoRpt;
    }
    
    public void setTipoRpt(RadioButtonGroup rbg) {
        this.tipoRpt = rbg;
    }
    
    private SingleSelectOptionsList tipoRptDefaultOptions = new SingleSelectOptionsList();
    
    public SingleSelectOptionsList getTipoRptDefaultOptions() {
        return tipoRptDefaultOptions;
    }
    
    public void setTipoRptDefaultOptions(SingleSelectOptionsList ssol) {
        this.tipoRptDefaultOptions = ssol;
    }
    ...
    public String btReport_action() {
        try {
            ...
            if (tipoRpt.getValue().toString().equals("S"))
                PageReport = PageReport + "&rptfilename=" + "DispTransferencia";
            else
                PageReport = PageReport + "&rptfilename=" + "Transferencia";
