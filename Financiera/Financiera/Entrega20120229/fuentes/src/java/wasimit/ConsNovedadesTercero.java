 ...
 */
public class ConsNovedadesTercero extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        novterceroDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet)getValue("#{SessionBean1.novterceroRowSet}"));
        novterceroDataProvider.refresh();
    }
    ...
    private CachedRowSetDataProvider novterceroDataProvider = new CachedRowSetDataProvider();

    public CachedRowSetDataProvider getNovterceroDataProvider() {
        return novterceroDataProvider;
    }

    public void setNovterceroDataProvider(CachedRowSetDataProvider crsdp) {
        this.novterceroDataProvider = crsdp;
    }
    ...
    public void prerender() {
      if ( this.isPostBack() )
        ...
        try {
            ...
            getSessionBean1().getNovterceroRowSet().setObject(
                    1, valorFiltro);
            getSessionBean1().getNovterceroRowSet().setObject(
                    2, "TODOS");
            getSessionBean1().getNovterceroRowSet().setObject(
           ...
           this.novterceroDataProvider.refresh();
        } catch (Exception e) {
